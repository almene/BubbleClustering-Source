...
def memberate(center, radius, distance_array):
    """
...
def cluster(data, level):
    ...
    for i in range(0, iteration):
        ...
        if radius < singleton_distance[center]:
            ...
            reward, membership = memberate(center, radius, distance_matrix)
    ...
    print(f"{minn}, {maxx}")
    return distance_matrix, associator_matrix
